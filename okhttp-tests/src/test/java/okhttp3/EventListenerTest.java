...
public final class EventListenerTest {
  ...
  @Test public void multipleDnsLookupsForSingleCall() throws IOException {
    ...
    assertNotNull(listener.removeUpToEvent(DnsStart.class));
    assertNotNull(listener.removeUpToEvent(DnsEnd.class));
    assertNotNull(listener.removeUpToEvent(DnsStart.class));
    assertNotNull(listener.removeUpToEvent(DnsEnd.class));
  }
  ...
  @Test public void multipleSecureConnectsForSingleCall() throws IOException {
    ...
    assertNotNull(listener.removeUpToEvent(SecureConnectStart.class));
    assertNotNull(listener.removeUpToEvent(SecureConnectEnd.class));
  ...
  static final class RecordingEventListener extends EventListener {
     ...
     * {@code eventClass} and returns it. If no events match or the event sequence is empty, returns
     * null.
     */
